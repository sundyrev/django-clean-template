...
echo -e "Are you sure you want to delete the project at \e[38;5;223m${project_path}\e[0m? \e[38;5;207m[y/N]\e[0m: \c"
read -e confirm
...
if [[ -f "${nginx_config}" ]]; then
    ...
    if [ $? -ne 0 ]; then
        echo -e "\e[38;5;196m[ERROR]\e[0m Failed to remove Nginx configuration ${nginx_config}."
        exit 1
    fi
...
echo -e "\e[38;5;48m[SUCCESS]\e[0m The project has been successfully deleted!"